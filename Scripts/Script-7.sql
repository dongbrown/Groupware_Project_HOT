...
SELECT * FROM APPROVAL JOIN EXPENDITURE_FORM USING(APPROVAL_NO) JOIN EXPENDITURE_ITEM USING(EXPENDITURE_FORM_NO);
SELECT * FROM APPROVAL a
	LEFT JOIN APPROVER b ON a.APPROVAL_NO = b.APPROVAL_NO
	LEFT JOIN EXPENDITURE_FORM e ON a.APPROVAL_NO = e.APPROVAL_NO
	LEFT JOIN APPROVAL_ATT aa ON a.APPROVAL_NO = aa.APPROVAL_NO
	LEFT JOIN REFERENCE r ON r.APPROVAL_NO = a.APPROVAL_NO
	LEFT JOIN EXPENDITURE_ITEM ei ON ei.EXPENDITURE_FORM_NO = e.EXPENDITURE_FORM_NO
WHERE e.EXPENDITURE_FORM_NO = 5;

DELETE FROM EXPENDITURE_FORM WHERE APPROVAL_NO='4-2024-0801-027';
