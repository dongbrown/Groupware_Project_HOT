...
<div id="work-first-wrap">
		<!-- 작업 조회시 업데이트 창 -->
		<div>
			<div id="work-update-title">작업 수정</div>
		</div>
			...
			<div style="display: flex; flex-direction: row; justify-content: center; margin-top: 30px;">
				...
				<input style="display:none;" type="text" name="workNo" value="${work.projectWorkNo }">
					...
					<div id="project-work-file" class="form-floating">
						<img id="dragFile" src="https://i.imgur.com/skjgqb0.png"
							height="100%" width="100%" />
						<button id="fileUploadBtn" type="button" class="btn btn-dark" onclick="document.getElementById('fileInput').click()">
						파일업로드</button>
					...
					<div style="display: flex; justify-content: center; align-items: center; margin-top: 30px; ">
						<button style="margin:20px;" type="button"
							class="btn btn-secondary" id="workUpdateCancle">목록으로</button>
						<button style="margin:20px;" id="workUpdateBtn" type="button" class="btn btn-primary" data-bs-toggle="modal"
							data-bs-target="#updateSelectModal">작업 수정</button>
						<button style=" margin:20px; display:none;" type="button" id="compeleteWorkBtn" class="btn btn-success">작업 완료</button>
					</div>
...
<script src="${path }/js/project/updateWorkDetail.js"></script>
