...
<div class="container-fluid">
    <h2 class="mb-4">중요 메일함<span class="email-count">${emails.size()}</span></h2>
    <!-- 검색 폼 include -->
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between mb-3">
                <div>
                    ...
                    <!-- <button id="unmarkImportantBtn" class="btn btn-sm btn-warning">중요 해제</button> -->
                </div>
            </div>
