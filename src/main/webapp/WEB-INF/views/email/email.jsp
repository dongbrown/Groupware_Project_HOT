                ...
                <div class="col-md-2">
                   <div class="emailSidebar">
					...
					<ul class="list-group">
					    ...
					    <li class="list-group-item email-link" data-mailbox="trash">
