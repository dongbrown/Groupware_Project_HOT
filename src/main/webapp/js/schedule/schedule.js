$(document).ready(function() {
        ...
        eventSources: [
            {
                events: function(start, end, timezone, callback) {
                    $.ajax({
						url: 'http://14.36.141.71:10079/GDJ79_HOT_final/schedule/all',
                        type: 'GET',
                        dataType: 'json',
  ...
  $('#addScheduleForm').submit(function(e) {
    ...
    $.ajax({
      url: 'http://14.36.141.71:10079/GDJ79_HOT_final/schedule/addSchedule',
      type: 'POST',
  ...
  $('#deleteScheduleBtn').click(function() {
    ...
    if (confirm('정말로 이 일정을 삭제하시겠습니까?')) {
      $.ajax({
        url: 'http://14.36.141.71:10079/GDJ79_HOT_final/schedule/deleteSchedule',
        type: 'DELETE',
        data: { id: scheduleId },
        success: function(response) {
          refreshCalendarAndSidebar();
    ...
    function loadDepartments(prefix = '') {
        $.ajax({
            url: 'http://14.36.141.71:10079/GDJ79_HOT_final/api/employee/departmentList',
            type: 'GET',
            dataType: 'json',
    ...
    function loadEmployees(deptCode, prefix = '') {
        $.ajax({
            url: 'http://14.36.141.71:10079/GDJ79_HOT_final/schedule/selectEmpByDept',
            type: 'GET',
    ...
    function updateSchedule(event, isDragUpdate) {
        ...
        $.ajax({
            url: 'http://14.36.141.71:10079/GDJ79_HOT_final/schedule/updateSchedule',
            type: 'PUT',
            contentType: 'application/json',
    ...
    function refreshCalendarAndSidebar() {
        $('#calendar').fullCalendar('refetchEvents');
        $.ajax({
            url: 'http://14.36.141.71:10079/GDJ79_HOT_final/schedule/',
            type: 'GET',
            success: function(response) {
                var $html = $(response);
    ...
    $("#addCompanyScheduleForm").submit(function(e) {
        ...
        $.ajax({
            url: 'http://14.36.141.71:10079/GDJ79_HOT_final/schedule/addCompanySchedule',
            type: "POST",
            contentType: "application/json",
